            ...
            <div class="main-page">
                <div class="container-fluid">
                    <div class="row page-title-div">
                        <div class="col-md-6">
                            <h2 class="title">Actualizar Modulo</h2>
                        </div>
                    ...
                    <div class="row breadcrumb-div">
                        <div class="col-md-6">
                            <ul class="breadcrumb">
                                ...
                                <li class="active">Actualizar Modulo</li>
                            </ul>
                        </div>
                                ...
                                <div class="panel">
                                    <div class="panel-heading">
                                        <div class="panel-title">
                                            <h5>Actualizar Información de Modulo</h5>
                                        </div>
                                    </div>
                                    <?php if ($msg) { ?>
                                        ...
                                        if ($query->rowCount() > 0) {
                                            foreach ($results as $result) {   ?>
                                                ...
                                                <div class="form-group has-success">
                                                    <label for="success" class="control-label">Nombre de Modulo</label>
                                                    <div class="">
                                                ...
                                                <div class="form-group has-success">
                                                    <label for="success" class="control-label">Nombre de Modulo en Número</label>
                                                    <div class="">
