                                    ...
                                    <form class="form-horizontal" method="post">
                                        ...
                                        if ($query->rowCount() > 0) {
                                            foreach ($results as $result) {  ?>
                                                ...
                                                <div class="form-group">
                                                    <label for="default" class="col-sm-2 control-label">Cedula</label>
                                                    <div class="col-sm-10">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10">
                                                        ...
                                                        if ($gndr == "Male") {
                                                        ?>
                                                            <input type="radio" name="gender" value="Male" required="required" checked>Hombre <input type="radio" name="gender" value="Female" required="required">Mujer <input type="radio" name="gender" value="Other" required="required">Other
                                                        <?php } ?>
                                                        <?php
                                                        if ($gndr == "Female") {
                                                        ?>
                                                            <input type="radio" name="gender" value="Male" required="required">Hombre <input type="radio" name="gender" value="Female" required="required" checked>Mujer <input type="radio" name="gender" value="Other" required="required">Other
                                                        <?php } ?>
                                                        <?php
                                                        if ($gndr == "Other") {
                                                        ?>
                                                            <input type="radio" name="gender" value="Male" required="required">Hombre <input type="radio" name="gender" value="Female" required="required">Mujer <input type="radio" name="gender" value="Other" required="required" checked>Other
                                                        <?php } ?>
