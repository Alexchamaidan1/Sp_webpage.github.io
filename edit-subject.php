            ...
            <div class="main-page">
                ...
                <div class="container-fluid">
                    <div class="row page-title-div">
                        <div class="col-md-6">
                            <h2 class="title">Actualizar Clase</h2>
                                        ...
                                        if ($query->rowCount() > 0) {
                                            foreach ($results as $result) {   ?>
                                                <div class="form-group">
                                                    <label for="default" class="col-sm-2 control-label">Nombre Clase</label>
                                                    <div class="col-sm-10">
                                                ...
                                                <div class="form-group">
                                                    <label for="default" class="col-sm-2 control-label">Código Clases</label>
                                                    <div class="col-sm-10">
