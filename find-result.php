...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="assets/images/logosp.png">
                    ...
                    <div class="panel login-box" style="    background: #3d86ed;">
                        <div class="panel-heading">
                            <div class="panel-title text-center">
                                <a href="#">
                                    <img style="height: 100px" src="assets/images/academicosp.png"></a>
                        ...
                        <div class="panel-body p-20">
                            ...
                            <form action="result.php" method="post" class="admin-login">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="rollid" placeholder="Ingresa tu Cedula" autocomplete="off" name="rollid">
                                </div>
                                <div class="form-group">
                                    <label for="default" class="control-label">Modulos</label>
                                    <select name="class" class="form-control" id="default" required="required">
                                        <option value="">Selecciona tu Modulo</option>
