    ...
    <?php
                                              ...
                                              if (!empty($_POST["classid1"])) {
                                                ...
                                                if (!is_numeric($cid1)) {
                                                  ...
                                                  while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) { ?>
      <p> <?php echo htmlentities($row['SubjectName']); ?><input type="text" name="marks[]" value="" class="form-control" required="" placeholder="Introducir puntos sobre 10" autocomplete="off"></p>
