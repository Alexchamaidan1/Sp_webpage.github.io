    ...
    <div class="sidebar-content">
        ...
        <div class="sidebar-nav">
            <ul class="side-nav color-gray">
                ...
                <li>
                    <a href="dashboard.php"><i class="fa fa-dashboard"></i> <span>Panel Control</span> </a>
                ...
                <li class="has-children">
                    <a href="#"><i class="fa fa-file-text"></i> <span>Gestión de Modulos</span> <i class="fa fa-angle-right arrow"></i></a>
                    <ul class="child-nav">
                        <li><a href="create-class.php"><i class="fa fa-plus"></i> <span>Crear Modulo</span></a></li>
                        <li><a href="manage-classes.php"><i class="fa fa-bars"></i> <span>Gestionar Modulo</span></a></li>

                    </ul>
                </li>
                <li class="has-children">
                    <a href="#"><i class="fa fa-book"></i> <span>Clases</span> <i class="fa fa-angle-right arrow"></i></a>
                    <ul class="child-nav">
                        <li><a href="create-subject.php"><i class="fa fa-plus"></i> <span>Crear Clases</span></a></li>
                        <li><a href="manage-subjects.php"><i class="fa fa-bars"></i> <span>Gestionar Clases</span></a></li>
                        <li><a href="add-subjectcombination.php"><i class="fa fa-plus"></i> <span>Gestionar Relación Clases</span></a></li>
                        <a href="manage-subjectcombination.php"><i class="fa fa-bars"></i> <span>Ver Relación de Clases</span></a>
                </li>
            </ul>
            </li>
            <li class="has-children">
