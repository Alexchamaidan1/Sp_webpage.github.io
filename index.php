...
<head>
  ...
  <title>Sembradores de Paz - ISPEEL</title>
  <meta content="width=device-width, initial-scale=1.0" name="viewport">
  <meta content="Free HTML Templates" name="keywords">
  <meta content="Free HTML Templates" name="description">

  <!-- Favicon -->
  <link href="./assets/images/logosp.png" rel="icon">
...
<body>
    ...
    <div class="row py-2 px-lg-5">
      <div class="col-lg-6 text-center text-lg-left mb-2 mb-lg-0">
        <div class="d-inline-flex align-items-center text-white">
          <small><i class="fa fa-phone-alt mr-2"></i>0944014927</small>
          <small class="px-3">|</small>
          <small><i class="fa fa-envelope mr-2"></i>mieajsembradoresdepaz@gmail.com</small>
        </div>
      </div>
      <div class="col-lg-6 text-center text-lg-right">
        <div class="d-inline-flex align-items-center">
          <a class="text-white px-2" href="https://www.facebook.com/SPSembradoresdePaz/">
            <i class="fab fa-facebook-f"></i>
          </a>
          <a class="text-white px-2" href="https://www.instagram.com/minist_sp/">
            <i class="fab fa-instagram"></i>
          </a>
          <a class="text-white pl-2" href="https://www.youtube.com/@sembradoresdepaz-ispeel1715/videos">
  ...
  <div class="container-fluid p-0">
    <nav class="navbar navbar-expand-lg bg-white navbar-light py-3 py-lg-0 px-lg-5">
      <a href="index.php" class="navbar-brand ml-lg-3">
        <h1 class="m-0 text-uppercase text-primary"><i class="fa fa-church mr-3"></i>SEMBRADORES DE PAZ - ISPEEL</h1>
      </a>
      ...
      <div class="collapse navbar-collapse justify-content-between px-lg-3" id="navbarCollapse">
        <div class="navbar-nav mx-auto py-0">
          ...
          <a href="#" class="nav-item nav-link">Modulos</a>
          <div class="nav-item dropdown">
            <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">Páginas</a>
            <div class="dropdown-menu m-0">
              <a href="#" class="dropdown-item">Información de los Modulos</a>
              <a href="#" class="dropdown-item">Beneficios Adicionales</a>
              <a href="#" class="dropdown-item">Pastores</a>
        ...
        <a href="admin-login.php" class="btn btn-primary py-2 px-4 d-none d-lg-block">Maestros</a>
      </div>
    </nav>
  </div>
  <!-- Navbar End -->
  ...
  <!-- Header Start -->
  <div class="jumbotron" style="background-size: cover; background-image: url(assets/images/fondoindex.jpg)">
    <div class="container text-center my-5 py-5">
      <h1 class="text-white display-1 mb-5"></h1>
      <h1 class="text-white mt-4 mb-4"></h1>
      <div class="mx-auto mb-4" style="width: 100%; max-width: 5px;">
      </div>
    </div>
  </div>
  <!-- Header End -->
      ...
      <div class="row">
        <div class="col-lg-5 mb-5 mb-lg-0" style="min-height: 500px;">
          <div class="position-relative h-100">
            <img class="position-absolute w-100 h-100" src="./assets/images/imagen1.jpg" style="object-fit: cover;">
          </div>
        </div>
        <div class="col-lg-7">
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-5" style="min-height: 500px;">
          <div class="position-relative h-100">
            <img class="position-absolute w-100 h-100" src="./assets/images/imagen2.jpg" style="object-fit: cover;">
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="container py-5">
      <div class="row align-items-center">
        <div class="col-lg-5 mb-6 mb-lg-0">
          <div class="bg-light d-flex flex-column justify-content-center px-6" style="height: 460px;">
            <div class="d-flex align-items-center mb-5">
              ...
              <div class="mt-n1">
                ...
                <p class="m-0">Coop. Santiaguito Roldos Bucaram Mz. 1169 SL1, Guayaquil, Ecuador</p>
              </div>
            </div>
            <div class="d-flex align-items-center mb-5">
              <div class="btn-icon bg-secondary mr-4">
            ...
            <div class="d-flex align-items-center">
              ...
              <div class="mt-n1">
                <h4>Correo</h4>
                <p class="m-0">mieajsembradoresdepaz@gmail.com</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="row">
        <div class="col-md-6 mb-5">
          <a href="index.html" class="navbar-brand">
            <h1 class="mt-n2 text-uppercase text-white"><i class="fa fa-church mr-3"></i>SEMBRADORES DE PAZ-ISPEEL</h1>
          </a>
