...
<head>
    ...
    <title>Resultados Estudiante-sp</title>
            ...
            <div class="content-container">
                ...
                <div class="main-page">
                    <div class="container-fluid">
                        ...
                        <h2>Resultado del Modulo - NOTAS</a></h2>
                                            ...
                                            <div class="panel-title">
                                                ...
                                                if ($stmt->rowCount() > 0) {
                                                    foreach ($resultss as $row) {   ?>
                                                        ...
                                                        <p><b>Cedula:</b> <?php echo htmlentities($row->RollId); ?>
                                                        <p><b>Modulo:</b> <?php echo htmlentities($row->ClassName); ?>(<?php echo htmlentities($row->Section); ?>)
                                                        <?php }
                                                ...
                                                <table class="table table-hover table-bordered" border="1" width="100%">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <?php
                                                            ...
                                                            <?php
                                                            echo htmlentities("Inválido no eres estudiantes");
                                                        }
                                                            ?>
                                                            </div>
                                                    </tbody>
